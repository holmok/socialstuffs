...
REPO="us-central1-docker.pkg.dev/socialstuffs/prod-website"
...
gcloud run deploy prod-website-service \
  --image us-central1-docker.pkg.dev/socialstuffs/prod-website/socialstuffs:latest \
  --region us-central1 \
