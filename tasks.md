...
- **Phase 7 complete** (merged): PR [#31](https://github.com/holmok/socialstuffs/pull/31) report-only coverage tooling (`test`/`test:coverage` scripts + `bunfig.toml`), [#32](https://github.com/holmok/socialstuffs/pull/32) flash/session + error-middleware tests (7.4, 7.5), [#33](https://github.com/holmok/socialstuffs/pull/33) sign-in/sign-up/JWT route tests (7.2, 7.3); docs [#34](https://github.com/holmok/socialstuffs/pull/34).
- **Post-audit follow-ups:** tracked in [followup.md](followup.md) (verification of every finding against main, residuals, and new findings).
