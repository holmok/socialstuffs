...
### F27. Zod: v3-style transforms produce NaN instead of validation errors; hand-rolled form validation
...
### F29. jsonwebtoken (CommonJS) instead of `hono/jwt`; double-signing
