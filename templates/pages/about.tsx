    ...
    <div class="about">
      ...
      <section>
        ...
        <p>
          ...
          favorited or approved, newest first, and when you hit the bottom, that's it. There is a link to older posts if you feel
          like digging.
        </p>
        <p>
      ...
      <section>
        ...
        <p>
          Posts here don't keep score. There are no likes, view counts, or share numbers, so there's nothing to chase and nothing
          to perform for. You're just writing for the people who'll read it.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Approving and disapproving covers everyone else. When you approve someone, their posts join your home feed, and they can
          see anything you share with people you approved. When you disapprove someone, posts you send to "everyone except people
          I disapprove" skip them. Both are just buttons on a profile. Click one to set it, click it again to take it back, or
      ...
      <section>
        ...
        <p>
          Your own feed works the same way. It only ever contains you and the people you picked, and nobody can pay us to show up
          in it.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          We use AI for one thing. Every picture and every bit of text gets checked when it's posted, to catch rude, lewd, or mean
          stuff before anyone has to see it. No filter catches everything, but we try hard to keep this place safe and friendly.
        </p>
      ...
      <section>
        ...
        <p>
          ...
          door that requires signing in, and screening on everything that gets uploaded. There just isn't much machinery here that
      ...
      <section>
        ...
        <p>
          You can download everything you've ever posted (profile, posts, pictures) as a single zip, any day you like (up to once
          a day). And if you decide to leave, deleting your account really deletes it. Posts, pictures, connections, all of it,
          wiped from our database and our storage. We don't keep a copy for our records, because they aren't our records.
        </p>
      </section>
