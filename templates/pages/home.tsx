    ...
    <Layout title="Home" description={description}>
      <div class="home-anon">
        <section class="hero">
          ...
          <p class="tagline">
            socialstuffs is a simple place to post things for the people you choose. There&rsquo;s no ranking machine deciding
        ...
        <section class="pitch">
          ...
          <ul class="pitch-list">
            ...
            <li>
              <h3>Your circle</h3>
              <p>
                Favorite the people you never want to miss, approve the ones you trust, disapprove of any annoying folks. The
                whole site is built around people you actually know and want to connect with.
              </p>
            </li>
            <li>
            ...
            <li>
              ...
              <p>
                If you delete your account, your data actually gets erased from our database and our storage. We don't archive it
                or hide it behind a "deactivated" flag.
              </p>
            </li>
            <li>
              <h3>No legalese</h3>
              <p>
                Our <a href="/terms">Terms</a> and <a href="/privacy">Privacy Policy</a> do not require a law degree to
                understand.
              </p>
            </li>
          </ul>
